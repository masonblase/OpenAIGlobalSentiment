...
Language source can be changed by swapping the two-letter ISO-639-1 language code in the 'language' parameter of the newsapi.get_everything() function on line 37.
